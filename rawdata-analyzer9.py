...
voyage_end_date = pd.to_datetime('2025-05-11') # add one day
...
df_calc['speed_through_water'] = df_calc.apply(
    lambda row: (row['engine_rpm'] * row['propeller_pitch'] * (1-row['slip_percentage']) * 60) / 1852)
...
output_path = 'C:/Users/Laptop-SatyoYuwono/Downloads/FZ-RESULT-VOY6.xlsx'
