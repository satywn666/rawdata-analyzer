...
output_path = 'C:/Users/Laptop-SatyoYuwono/Downloads/REV15-FINAL10.xlsx'
...
bar2.add_data(Reference(ws1, min_col=2, min_row=start_row-1, max_col=4, max_row=start_row+len(df_filtered_hrs)-2), titles_from_data=False)
bar2.set_categories(Reference(ws1, min_col=2, min_row=start_row, max_col=4, max_row=start_row+len(df_filtered_hrs)-1))
